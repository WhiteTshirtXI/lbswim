...
#if defined (MPI)
   call mpi_bcast(nstep,1,mpi_integer4,rootid,mpi_comm_world,ierr)
   call mpi_bcast(iseed,1,mpi_integer4,rootid,mpi_comm_world,ierr)
#endif
...
#if defined (MPI)
   call mpi_bcast(idump,1,mpi_integer4,rootid,mpi_comm_world,ierr)
   call mpi_bcast(ldumpswim,1,mpi_logical,rootid,mpi_comm_world,ierr)
   call mpi_bcast(ldumplat,1,mpi_logical,rootid,mpi_comm_world,ierr)
   call mpi_bcast(lformatted,1,mpi_logical,rootid,mpi_comm_world,ierr)
   call mpi_bcast(lrestore,1,mpi_logical,rootid,mpi_comm_world,ierr)
#endif
